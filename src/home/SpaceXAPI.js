            ...
            <div>
                <div>
                    ...
                    <div class="collapse multi-collapse" id="rocket1">
                        <div class="card card-body">
                            ...
                            <div>Rocket Name: <span id="rocket_name1"> </span> </div>
                ...
                <div>
                    ...
                    <div class="collapse multi-collapse" id="rocket2">
                        <div class="card card-body">
                            ...
                            <div>Rocket Name: <span id="rocket_name2"> </span> </div>
                            <div>Crew: <span id="crew2">  </span> </div>
                            <div>Launch Pad: <span id="launch2"> </span> </div>
                            <div>Location: <span id="location2"> </span> </div>
                            <details>
                                <summary>Details:</summary>
                ...
                <div>
                    ...
                    <div class="collapse multi-collapse" id="rocket3">
                        <div class="card card-body">
                            <div>Time(UTC): <span id="date_utc3"></span> </div>
                            <div>Time(local): <span id="date_local3"></span> </div>
                            <div>Rocket Name: <span id="rocket_name3"></span> </div>
                            <div>Crew: <span id="crew3">  </span> </div>
                            <div>Location: <span id="location3"> </span> </div>
                            <details>
                                <summary>Details</summary>
